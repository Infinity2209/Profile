        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              Hi, my name is <span className="yellow">Ananta Nag</span>
              and I'm from <span className="yellow">Bargarh, Odisha, India</span>
              <br />
              <br />
              I recently Persuing a Bachelor's degree in Computer Science and Engineering in Government College of Engineering, Kalahandi.
              <br />
              <br />
              As a
