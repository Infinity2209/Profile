...
import {
    Briefcase, Laptop, BookOpen, Building2
} from "lucide-react";

const nodes = [
    {
        year: "May 2026 – Present",
        title: "System Engineer — Tata Consultancy Services (TCS)",
        icon: Building2,
        desc: "Currently working as a System Engineer at Tata Consultancy Services (TCS), starting May 2026. Contributing to enterprise-scale software delivery, collaborating with cross-functional teams on production systems, and applying full-stack and cloud expertise within a large, structured engineering organization.",
        tags: ["TCS", "System Engineer", "Enterprise Systems", "Currently Working"],
        color: "#3b82f6",
        bg: "#eff6ff",
        darkBg: "#1e3a8a",
        tagBg: "#dbeafe",
    ...
    {
        year: "2021 - 2025",
        title: "B.Tech CSE — GCE Kalahandi",
        icon: BookOpen,
